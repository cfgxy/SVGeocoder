...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
    ...
    if(self.completionBlock) {
        ...
        else if(!error && [(NSObject*)self.delegate respondsToSelector:@selector(geocoder:didFindPlacemarksRaw:)])
            [self.delegate geocoder:self didFindPlacemarksRaw:response];
